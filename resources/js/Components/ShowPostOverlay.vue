        ...
        <div class="max-w-6xl h-[calc(100%-100px)] mx-auto mt-10 bg-white rounded-xl">
            <div class="w-full md:flex h-full overflow-auto rounded-xl">
                <div class="flex items-center bg-black w-full">
                    <img src="https://picsum.photos/id/54/800/820" alt="Post" class="rounded-xl min-w-[400px] p-4 mx-auto">
                </div>

                <div class="md:max-w-[500px] w-full relative">
                    <div class="flex items-center justify-between p-3 border-b">
                        <div class="flex items-center">
                            <img src="https://picsum.photos/id/54/800/820" alt="Profile Picture" class="rounded-full w-[38px] h-[38px]">
                    ...
                    <div class="overflow-y-auto h-[calc(100%-170px)]">
                        <div class="flex items-center justify-between p-3">
                            <div class="flex items-center relative">
                                <img src="https://picsum.photos/id/54/800/820" alt="Profile Picture" class="absolute -top-1 rounded-full w-[38px] h-[38px]">
                                <div class="ml-14">
