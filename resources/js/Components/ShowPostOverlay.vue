        ...
        <div class="max-w-6xl h-[calc(100%-100px)] mx-auto mt-10 bg-white rounded-xl">
            <div class="w-full md:flex h-full overflow-auto rounded-xl">
                <div class="flex items-center bg-black w-full">
                    <img :src="post.file" :alt="'Post by ' + post.user.name" class="rounded-xl min-w-[400px] p-4 mx-auto">
                </div>

                <div class="md:max-w-[500px] w-full relative">
                    <div class="flex items-center justify-between p-3 border-b">
                        <div class="flex items-center">
                            <img :src="post.user.file" :alt="post.user.name + '\'s Profile Picture'" class="rounded-full w-[38px] h-[38px]">
                    ...
                    <div class="overflow-y-auto h-[calc(100%-170px)]">
                        <div class="flex items-center justify-between p-3">
                            <div class="flex items-center relative">
                                <img :src="post.user.file" :alt="post.user.name + '\'s Profile Picture'" class="absolute -top-1 rounded-full w-[38px] h-[38px]">
                                <div class="ml-14">
                        ...
                        >
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <img :src="comment.user.file" :alt="comment.user.name + '\'s Profile Picture'" class="rounded-full w-[38px] h-[38px]">
